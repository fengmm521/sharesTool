...
#INSERT INTO `shares_dat`.`fuquanselectshares` (`shareid`, `date`) VALUES ('000001', '2017-03-06');

outsrt = ''
ids = IDManger.getAllIDs()
for d in ids:
    outsrt += "INSERT INTO `shares_dat`.`fuquanselectshares` (`shareid`, `date`) VALUES ('%s', '2017-03-02');\n"%(d)
print outsrt
