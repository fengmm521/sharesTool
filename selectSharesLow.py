...
class SharesSelectObj():
	...
	def getAllRecommendDat(self):
		...
		self.selOutDic = {}
		self.selOutDic[3000] = self.findItemWithDat(ls3000,0.02,0.08)
		self.selOutDic[1000] = self.findItemWithDat(ls1000,0.02,0.07)
		self.selOutDic[600] = self.findItemWithDat(ls600,0.02,0.06)
		self.selOutDic[300] = self.findItemWithDat(ls300,0.02,0.05)
		self.selOutDic[150] = self.findItemWithDat(ls150,0.03,0.05)
